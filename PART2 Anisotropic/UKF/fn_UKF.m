function [x_state,P_cov,K_EKF_gain]=fn_UKF(x_init,x_current,h_0,alpha,x_state_ini,P_cov_ini,F_KF,G_KF,Q_KF,R_KF,G_t_1,G_t_2)
%% Unscendet Kalman Filter
    ...
    % Compute Kalam gain with Predicted Covariance Matrix
...
n    = size(x(:),1);
nPts = 2*n+1;            % the symmetric SUT is used
...
% Now calculate the 0th covariance term weight
